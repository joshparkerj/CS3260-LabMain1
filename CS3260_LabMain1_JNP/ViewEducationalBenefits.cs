...
{
    public partial class ViewEducationalBenefits : Form
    {
        private static ViewEducationalBenefits inst;
        public static ViewEducationalBenefits GetForm
        {
            get
            {
                if (inst == null || inst.IsDisposed)
                {
                    inst = new ViewEducationalBenefits();
                }
                return inst;
            }
        }

        public ViewEducationalBenefits()
        {
            InitializeComponent();
            inst = this;
        }
